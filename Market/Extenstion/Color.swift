...
extension Color {
    static let darkOrange: Color = Color("Orange")
    static let darkBlue: Color = Color("DarkBlue")
    static let backgorund: Color = Color("Background")
    static let grey: Color = Color("Grey")
    static let chevron: Color = Color("Chevron")
    static let subtitleText: Color = Color("SubtitleText")
